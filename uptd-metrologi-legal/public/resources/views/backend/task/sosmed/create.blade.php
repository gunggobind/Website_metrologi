    ...
    <div class="content-wrapper">
        <div class="content-header ml-4 mr-4">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Tambah Tugas Sosial Media</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <form action="{{ route('backend.task-sosmed.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <label class="col-sm-2 col-form-label font-weight-bold">Jumlah Token BCN <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <input type="integer" name="token_bcn" class="form-control" value="{{ old('token_bcn') }}" required>
